<?php
/**
 * Shared listing index: contextual header, filter bar, toolbar, map, grid, pagination.
 * Used by archive-yp_listing.php and the listing taxonomy templates.
 *
 * @package ypgh
 */

$ctx = ypgh_archive_context();
?>
<section class="archive-head">
	<div class="wrap">
		<p class="eyebrow"><?php echo esc_html( $ctx['eyebrow'] ); ?></p>
		<h1><?php echo esc_html( $ctx['title'] ); ?></h1>
		<?php if ( $ctx['intro'] ) : ?>
			<p class="archive-intro"><?php echo esc_html( $ctx['intro'] ); ?></p>
		<?php endif; ?>
...
<section class="section">
	<div class="wrap">
		...
		<?php else : ?>
			<p class="empty"><?php esc_html_e( 'No listings match these filters yet. Try widening your price range or clearing the verified-only toggle.', 'ypgh' ); ?></p>
		<?php endif; ?>
	</div>
</section>
